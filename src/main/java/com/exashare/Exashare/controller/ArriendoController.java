...
public class ArriendoController {
    ...
    @GetMapping("/herramientas-detalles")
    @Operation(summary = "Listar herramientas con usuario y arriendo", description = "Obtiene una lista de herramientas junto al usuario y los detalles del arriendo")
