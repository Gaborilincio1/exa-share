...
public class UsuarioController {
    ...
    @Operation(summary = "Listar resenas por usuario", description = "Obtiene una lista de reseñas asociadas a un usuario específico")
    public List<Map<String, Object>> getResenasPorUsuario(@PathVariable Integer id) {
        return usuarioService.getResenasPorUsuario(id);
    }
