...
public class ArriendoService {
    ...
    public void eliminarArriendo(Long id) {
        ...
        List<Resenas> resenas = resenasRepository.findByArriendo(arriendo);
        for (Resenas resena : resenas) {
            resenasRepository.delete(resena);
        }

        arriendoRepository.delete(arriendo);
    }
    ...
    return arriendoRepository.getHerramientasConUsuarioYArriendo();
    }
